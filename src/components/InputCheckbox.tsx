...
export default function InputCheckbox({
  ...
  return (
    <label className="grid grid-cols-[1em_auto] items-center gap-6">
      <div className="grid h-[1em] w-[1em] cursor-pointer place-items-center">
        <input
          type="checkbox"
          id={id}
          checked={value}
          ...
          className="col-start-1 row-start-1 h-[1em] w-[1em] cursor-pointer appearance-none border-2 border-almost-white checked:border-neon-green checked:bg-neon-green"
        />
